    ...
    <div className="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div className="row align-items-center px-3">
            <div className="col-lg-6 text-center text-lg-left">
                <h4 className="text-white mb-4 mt-5 mt-lg-0">Bilme Öğrenme Tanıma Merkezi</h4>
                <h1 className="display-3 font-weight-bold text-white"> YENİ EĞİTİM YAKLAŞIMLARIYLA ÖĞRENME</h1>
